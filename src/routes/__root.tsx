...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "The Ayurveda" },
      ...
      { name: "twitter:title", content: "The Ayurveda — Ancient Ayurveda. Modern Wellness." },
      { name: "twitter:description", content: "Premium Ayurvedic rituals, crafted from earth." },
    ],
    links: [
      {
        rel: "stylesheet",
